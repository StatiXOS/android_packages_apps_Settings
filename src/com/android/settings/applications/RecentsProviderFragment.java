...
public class RecentsProviderFragment extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.custom_recents_provider_fragment);
        mProviders = getProviders();
        PreferenceScreen prefScreen = getPreferenceScreen();
        SystemSettingListPreference pref = prefScreen.findPreference("custom_recents_provider");
        ...
        pref.setEntries(appLabels.toArray(new String[0]));
        pref.setEntryValues(mProviders.toArray(new String[0]));
    }
