...
import com.statix.sparks.fragments.QsTileStyles;

public class QSPreferenceController extends AbstractPreferenceController
    ...
    public QSPreferenceController(Context context, Lifecycle lifecycle, Fragment parent) {
        super(context);
        mParent = parent;
        if (lifecycle != null) {
    ...
    public void updateSummary() {
        if (mQsTileStylesPref != null) {
                mQsTileStylesPref.setSummary(mContext.getString(
                        com.android.settings.R.string.qs_selector_title));
        }
    }
}
