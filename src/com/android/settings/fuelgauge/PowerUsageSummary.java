...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
        ...
        if (KEY_BATTERY_TEMP.equals(preference.getKey())) {
            if (batteryTemp) {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.statix.Utils.batteryTemperature(getContext(), false));
                batteryTemp = false;
            } else {
                mBatteryTemp.setSubtitle(
                    com.android.internal.util.statix.Utils.batteryTemperature(getContext(), true));
                batteryTemp = true;
            }
        }
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.statix.Utils.batteryTemperature(getContext(), batteryTemp));
