...
public class DoubleTapSleepPreferenceController extends BasePreferenceController {
    ...
    private final String STATUSBAR = DOUBLE_TAP_SLEEP_GESTURE;
    private final String LOCKSCREEN = DOUBLE_TAP_SLEEP_LOCKSCREEN;
    ...
    public CharSequence getSummary() {
        return mContext.getText(R.string.double_tap_menu_summary);
    }
