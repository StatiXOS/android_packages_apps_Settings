...
public class DoubleTapStatusBarPreferenceController extends GesturePreferenceController {

    private final String SYSTEM_KEY = DOUBLE_TAP_SLEEP_GESTURE;
    static final int ON = 1;
    static final int OFF = 0;

    public DoubleTapStatusBarPreferenceController(Context context, String key) {
        super(context, key);
    }
